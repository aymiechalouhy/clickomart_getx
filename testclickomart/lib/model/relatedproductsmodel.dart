class RelatedProducts {
  ...
  RelatedProducts({this.status, this.response});
...
class Response {
  ...
  Response(
      {this.items, this.total, this.facets, this.path, this.subcategories});
  ...
  Response.fromJson(Map<String, dynamic> json) {
    ...
    // 	subcategories = <Null>[];
    // 	json['subcategories'].forEach((v) { subcategories!.add(Null.fromJson(v)); });
    // }
  }
...
class Facets {
  ...
  Facets({this.prices, this.attributes});
...
class RelatedProducts1 {
  String? status;
  Response? response;

  RelatedProducts1({this.status, this.response});

  RelatedProducts1.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    response =
        json['response'] != null ? Response.fromJson(json['response']) : null;
  }
...
class Currency1 {
  ...
  Currency1({this.name, this.symbol, this.code, this.conversionRate});

  Currency1.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    symbol = json['symbol'];
    code = json['code'];
    conversionRate = json['conversionRate'];
...
class Brand1 {
  ...
  Brand1({this.sId, this.name});

  Brand1.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    name = json['name'];
  }
...
class Cashback1 {
  ...
  Cashback1({this.cashbackAmount, this.cashbackType});

  Cashback1.fromJson(Map<String, dynamic> json) {
    cashbackAmount = json['cashbackAmount'];
    cashbackType = json['cashbackType'];
  }
...
class Facets1 {
  ...
  Facets1({this.brands, this.prices, this.attributes});

  Facets1.fromJson(Map<String, dynamic> json) {
    // if (json['brands'] != null) {
    // 	brands = <Brands>[];
    // 	json['brands'].forEach((v) { brands!.add(Brands.fromJson(v)); });
    // }
...
class Attributes1 {
  ...
  Attributes1({this.name, this.values});
