...
class Response {
	...
	Response({this.name, this.slug, this.outputResult, this.sId, this.items, this.viewType});
...
class Categories {
	...
	Categories({this.sId, this.name, this.slug, this.parentCategoryId, this.logo, this.icon});
